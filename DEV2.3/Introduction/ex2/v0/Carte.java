...
public class Carte {
    ...
    */
    ...
    public boolean egale(Carte c){
        ...
        if (!this.getVisible()) throw new IllegalStateException("this n'est pas visible");
        if (!c.getVisible()) throw new IllegalArgumentException("this n'est pas visible");
