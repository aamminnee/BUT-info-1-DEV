...
public class EnsembleCarte {
    ...
    */
    ...
    protected boolean add(Carte c){
        ...
        if (this.contenu.contains(c)) throw new IllegalStateException("la carte est déjà dans l'ensemble");
        this.nbreCarte++;
    ...
    private boolean remove(Carte c){
        boolean est = false;
        Objects.requireNonNull(c, "la carte à tester passée en paramètre ne peut pas être null toto");
        if (!this.contenu.contains(c)) throw new IllegalStateException("la carte n'est pas dans l'ensemble");
        this.nbreCarte--;
    ...
    public static void main(String[] args) {
         ...
         System.out.println(e1.add(quatre));
         quatre = null;
         System.out.println(e1.remove(quatre));

        // System.out.println(e1.remove(deuxBis));
